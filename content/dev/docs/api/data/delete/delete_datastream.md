...
Deletes the specified datastream.
...
<div class="code-examples">
  <table class="code-examples-table twelve">
    ...
    <tbody>
      ...
      <tr>
        <td>API Endpoint</td>
        <td>/v2/feeds/FEED_ID/datastreams/DATASTREAM_ID</td>
      </tr>
    </tbody>
  </table> 
  ...
  <ul class="apidoc-tabs-content tabs-content">
    <li class="active" id="request-jsonTab">
      <p>
        <strong style="margin-right:1em">DELETE</strong>/v2/feeds/FEED_ID/datastreams/DATASTREAM_ID
      </p>
      <!-- JSON -->
